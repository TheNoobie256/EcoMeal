 ...
 */
final class Version20260702092602 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE business (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, street VARCHAR(50) NOT NULL, city VARCHAR(50) NOT NULL, house_number VARCHAR(10) NOT NULL, phone_number VARCHAR(20) NOT NULL, business_type_id INT NOT NULL, INDEX IDX_8D36E38987F37DE (business_type_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
